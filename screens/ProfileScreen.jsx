  ...
  const ProfileHeader = () => (
    <View style={styles.container}>
      ...
      <View style={styles.nameContainer}>
        <Text style={styles.profileName}>Jimbo Delfin</Text>
        <Text style={styles.profileHandler}>@jimbonanza</Text>
      </View>

      <View style={styles.profileContainer}>
        <Text style={styles.profileContainerText}>Jimbo Delfin</Text>
      </View>

      <View style={styles.locationContainer}>
        <EvilIcons name="location" size={24} color="gray" />
        <Text style={styles.textGray}>Manila, PH</Text>
      </View>
